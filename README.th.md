...
| **Dashboard** | Durable view, widget instance, edit mode, drag/resize, App Launcher, **AI-authored content/script widget** (declarative JSON หรือ sandboxed iframe JS พร้อม permission), per-widget preset / accent / icon / title, **21 animated canvas background** (aurora, clouds, ocean, raindrops, snow, sakura, fireflies, bubbles, ricefield, lanterns, starfield, nebula, embers, lava, matrix, topo, synthwave, cyberpunk, taipei101, thunderstorm, confetti) |
