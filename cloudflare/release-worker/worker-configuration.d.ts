/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/release-worker/wrangler.jsonc cloudflare/release-worker/worker-configuration.d.ts` (hash: bbed6807ef38ba28939df0c911ec80fb)
