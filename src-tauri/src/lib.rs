...
pub fn run() {
    ...
    configure_macos_updater(configure_single_instance(tauri::Builder::default()))
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // ── IT Ops
            itops::commands::itops_list_fleets,
            itops::commands::itops_create_fleet,
            itops::commands::itops_update_fleet,
            itops::commands::itops_remove_fleet,
            itops::commands::itops_reorder_fleets,
            itops::commands::itops_resolve_fleet,
