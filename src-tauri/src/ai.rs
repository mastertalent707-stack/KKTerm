...
mod tests {
    ...
    #[test]
    fn dashboard_widget_tool_schema_requires_content_render_mode() {
        let schema = dashboard_create_widget_schema();
        let markdown_branch = schema
            .pointer("/properties/body/anyOf/0")
            .expect("markdown content branch exists");
