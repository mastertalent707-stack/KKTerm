...
- **Thêm widget Dashboard.** Widget tích hợp sống ở [`src/dashboard/widgets/`](src/dashboard/widgets/). Chọn một ý tưởng nhỏ, ship nó, học pattern.
