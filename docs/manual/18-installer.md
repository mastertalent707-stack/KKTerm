...
- **download-installer** — downloads a vendor-declared installer URL to a temp file and launches it with the normal Windows installer UI. Codex Desktop and Claude Desktop use this path because their canonical install surfaces are vendor download pages rather than package-manager recipes.
