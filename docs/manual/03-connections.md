...
| URL | `connections.embeddedWebApp` | Opens http(s) targets externally while embedded WebView2 is disabled. See [08-url-webview.md](08-url-webview.md). |
