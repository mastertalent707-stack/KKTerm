...
- **English value**: `Look for an HTTP-based MCP endpoint from the same provider, or check their documentation for a hosted option.`
- **Namespace**: `settings`
- **File/component**: `src/settings/McpServers.tsx` and `src/settings/AddMcpServerDialog.tsx`
- **UI role**: `fragment`
- **User flow**: Follow-up guidance text shown alongside mcpAddStdioUnsupported.
