...
- **English value**: `Keyboard shortcuts for the Workspace Module. Click a shortcut to record a new key combination, or clear it to leave the action without a shortcut.`
- **Namespace**: `settings`
- **File/component**: `src/modules/settings/ShortcutsSettings.tsx`
- **UI role**: `status`
- **User flow**: `Explanatory hint shown at the top of the Shortcuts settings section.`
...
<!--
Filename: settings.shortcutsHint.md
