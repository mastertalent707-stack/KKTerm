# workspace.fileViewer.filterLines

- **English value**: `Filter lines…`
- **Namespace**: `workspace`
- **File/component**: `src/modules/workspace/connections/file-viewer/FileViewerWorkspace.tsx`
- **UI role**: `placeholder`
- **User flow**: Placeholder in the log viewer line filter.
...
<!--
Filename: workspace.fileViewer.filterLines.md
