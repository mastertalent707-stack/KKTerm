# settings.shortcutZoomReset

- **English value**: `Reset font size`
- **Namespace**: `settings`
- **File/component**: `src/modules/settings/ShortcutsSettings.tsx`
- **UI role**: `label`
- **User flow**: `Row label in Shortcuts settings for the terminal font reset action.`
...
<!--
Filename: settings.shortcutZoomReset.md
