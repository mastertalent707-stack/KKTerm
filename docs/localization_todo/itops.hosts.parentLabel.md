# itops.hosts.parentLabel

- **English value**: `Parent Host`
- **Namespace**: `itops`
- **File/component**: `src/modules/itops/HostDialog.tsx`
- **UI role**: `label`
- **User flow**: Field label for the parent Host select (device carrying this VM/container).
