# workspace.fileViewer.filterRows

- **English value**: `Filter rows…`
- **Namespace**: `workspace`
- **File/component**: `src/modules/workspace/connections/file-viewer/FileViewerWorkspace.tsx`
- **UI role**: `placeholder`
- **User flow**: Placeholder in the table (CSV) viewer row filter.
...
<!--
Filename: workspace.fileViewer.filterRows.md
