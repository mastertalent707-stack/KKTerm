# workspace.fileViewer.truncated

- **English value**: `This file is large; showing a partial preview.`
- **Namespace**: `workspace`
- **File/component**: `src/modules/workspace/connections/file-viewer/FileViewerWorkspace.tsx`
- **UI role**: `status`
- **User flow**: Shown when only the leading portion of a large file is rendered.
...
<!--
Filename: workspace.fileViewer.truncated.md
