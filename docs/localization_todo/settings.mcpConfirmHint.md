...
- **English value**: `Review the parsed configuration before saving. KKTerm will probe the server's tool list immediately after creation.`
- **Namespace**: `settings`
- **File/component**: `src/settings/McpServers.tsx` and `src/settings/AddMcpServerDialog.tsx`
- **UI role**: `fragment`
- **User flow**: Help text on the confirmation step of the add dialog.
