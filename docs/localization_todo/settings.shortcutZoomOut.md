# settings.shortcutZoomOut

- **English value**: `Decrease font size`
- **Namespace**: `settings`
- **File/component**: `src/modules/settings/ShortcutsSettings.tsx`
- **UI role**: `label`
- **User flow**: `Row label in Shortcuts settings for the terminal font zoom-out action.`
...
<!--
Filename: settings.shortcutZoomOut.md
