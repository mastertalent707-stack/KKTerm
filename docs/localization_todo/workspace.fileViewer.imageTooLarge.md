# workspace.fileViewer.imageTooLarge

- **English value**: `This image is too large to preview.`
- **Namespace**: `workspace`
- **File/component**: `src/modules/workspace/connections/file-viewer/FileViewerWorkspace.tsx`
- **UI role**: `status`
- **User flow**: Shown when an image exceeds the preview size cap.
...
<!--
Filename: workspace.fileViewer.imageTooLarge.md
