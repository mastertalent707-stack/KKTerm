# workspace.fileViewer.kind.markdown

- **English value**: `Markdown`
- **Namespace**: `workspace`
- **File/component**: `src/modules/workspace/connections/file-viewer/FileViewerWorkspace.tsx`
- **UI role**: `label`
- **User flow**: Viewer-mode switch button for rendered Markdown.
...
<!--
Filename: workspace.fileViewer.kind.markdown.md
