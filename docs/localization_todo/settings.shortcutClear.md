...
- **English value**: `Remove shortcut`
- **Namespace**: `settings`
- **File/component**: `src/modules/settings/ShortcutsSettings.tsx`
- **UI role**: `tooltip`
- **User flow**: `Tooltip/aria-label for the per-row button that clears a shortcut, leaving the action unbound.`
...
<!--
Filename: settings.shortcutClear.md
