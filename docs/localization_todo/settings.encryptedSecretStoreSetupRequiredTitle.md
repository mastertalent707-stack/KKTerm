# settings.encryptedSecretStoreSetupRequiredTitle

- **English value**: `Encrypted database storage needs setup`
- **Namespace**: `settings`
...
<!--
Filename: settings.encryptedSecretStoreSetupRequiredTitle.md
