# connections.fileView

- **English value**: `File Viewer`
- **Namespace**: `connections`
- **File/component**: `src/modules/workspace/connections/file-viewer/FileViewerWorkspace.tsx`
- **UI role**: `label`
- **User flow**: Name of the File Viewer Connection type in the New Connection menu and dialog title.
...
<!--
Filename: connections.fileView.md
