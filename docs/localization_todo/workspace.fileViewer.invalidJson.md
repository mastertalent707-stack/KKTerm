# workspace.fileViewer.invalidJson

- **English value**: `Invalid JSON — showing raw text.`
- **Namespace**: `workspace`
- **File/component**: `src/modules/workspace/connections/file-viewer/FileViewerWorkspace.tsx`
- **UI role**: `status`
- **User flow**: Shown when the JSON viewer cannot parse the file and falls back to raw text.
...
<!--
Filename: workspace.fileViewer.invalidJson.md
