# settings.shortcutPreviousTab

- **English value**: `Previous tab`
- **Namespace**: `settings`
- **File/component**: `src/modules/settings/ShortcutsSettings.tsx`
- **UI role**: `label`
- **User flow**: `Row label in Shortcuts settings for the activate-previous-Tab action.`
...
<!--
Filename: settings.shortcutPreviousTab.md
