...
- `src/modules/settings/WorkspaceSettings.tsx` — Workspace display preferences, including whether the top Tab Strip is hidden in favor of Child Connection Tabs under parent Connections in the Connection Tree and whether saved Connections require double-click to open from that tree.
