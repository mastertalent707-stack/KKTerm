...
- **Rack** — a durable, fixed-height (default 42U) cabinet that belongs to one
  ...
  an optional **shell** finish (black/white/grey). Holds Rack Items at U
...
- **Server Room** — a string grouping tag on a Rack (e.g. "Room B"). It nests
  the Rack View tree and scopes a Batch Run; blank server rooms group under
