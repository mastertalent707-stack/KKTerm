...
Each file name below maps to a placeholder image in the README — replace the
placeholders with real captures (PNG, ~720px wide recommended).

| File | Section |
| --- | --- |
| `hero.png` | Top hero shot of the full app |
